...
namespace UniMagContributions.Migrations
{
    ...
    [Migration("20240310152226_UpdateFacultyDescription")]
    partial class UpdateFacultyDescription
    {
            ...
            modelBuilder.Entity("UniMagContributions.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("7a499324-ecbd-4109-891a-4bd42d9a845a"),
                            Name = "Administrator"
                        },
                        new
                        {
                            RoleId = new Guid("5460bf39-7f5f-4879-b7fe-c217874bd586"),
                            Name = "Manager"
                        },
                        new
                        {
                            RoleId = new Guid("ca558437-997e-47f5-8aa2-32c9b65b4c1a"),
                            Name = "Coordinator"
                        },
                        new
                        {
                            RoleId = new Guid("156670bd-1025-455a-9a7b-546239182540"),
                            Name = "Student"
                        });
                });
